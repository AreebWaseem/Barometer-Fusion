...
// rc_read_values();
  get_accelero_values();
 // pressure_baro=bmp.readAltitude();
  //Serial.println(pressure_baro);
  while(Serial3.available())
  {
    for_baro=Serial3.read();
    if (for_baro=='\n')
    {
      pressure_baro=for_bari.toFloat();
      for_bari="";
    }
    else
    {
...
Serial2.print("$");
Serial2.print(",");
Serial2.print(sensor_x);
Serial2.print(",");
//Serial2.print("sensor_y");
Serial2.print(sensor_y);
Serial2.print(",");
//Serial2.print("sensor_z");
Serial2.print(sensor_z);
Serial2.print(",");
//Serial2.print("roll");
Serial2.print(roll);
...
Serial2.print(yaw);
Serial2.print(",");
Serial2.print(pressure_baro);
Serial2.println(",");
//Serial.println(pressure_baro);
/*
Serial2.println("altitude");
Serial2.println(pressure_baro);
*/
